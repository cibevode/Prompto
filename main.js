...
var PROMPT_TEMPLATE = '---\nname: "{{name}}"\ncategory: General\ntags: []\nversion: 1\neffectiveness: 0\nlastUsed: ""\nicon: "file-text"\nfavorite: false\n---\nWrite your prompt instructions here. Be specific about the role, task, and output format you want.\n\n## Using Variables\n\nVariables make your prompts reusable across different situations. Wrap any word in double curly braces and Prompto will auto-detect it:\n\n- {{selected_text}} \u2014 Auto-fills with highlighted text from the editor. Perfect for \"review this\" or \"rewrite this\" prompts.\n- {{topic}} \u2014 A subject to focus on. Useful for research, writing, or brainstorming prompts.\n- {{audience}} \u2014 Who the output is for. Helps the AI adjust tone and complexity.\n- {{tone}} \u2014 The writing style: formal, casual, technical, friendly, etc.\n- {{language}} \u2014 Programming language or spoken language, depending on context.\n- {{format}} \u2014 Desired output structure: bullet points, essay, table, JSON, etc.\n- {{constraints}} \u2014 Boundaries, word limits, things to avoid, or specific requirements.\n\nYou can invent any variable name you want \u2014 the ones above are just common examples.\n\n## Tips for Great Prompts\n\n1. Start with a role: \"You are a senior editor\" or \"Act as a data analyst\"\n2. Be specific about the task: \"Review for bugs\" beats \"Look at this code\"\n3. Define output format: \"Respond in 3 sections: Summary, Issues, Recommendations\"\n4. Add constraints: \"Keep it under 200 words\" or \"No jargon\"\n5. Use variables for the parts that change \u2014 keep structure and instructions fixed\n\n## Example\n\nYou are an expert {{language}} developer. Review this code:\n\n{{selected_text}}\n\nPrioritize: {{priorities}}\n\nFor each issue, show the problematic line and a concrete fix.\n';
