...
2. Copy `obsidian-plugin/main.js` and `obsidian-plugin/manifest.json` into:
   ```
...
│   ├── main.js                 Built plugin (803 lines)
...
npm run dev
```
Symlink the folder into your vault's `.obsidian/plugins/prompto/` for live testing.
